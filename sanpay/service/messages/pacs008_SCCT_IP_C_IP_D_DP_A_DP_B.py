data = {
	...
	'Charges_bearer': 'SHAR',
    'Debtor_Agent': 'PREVPKK0',
	'Debtor_Agent_Account': '1356789024',
	...
	<Body>
		...
		<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08">
			<FIToFICstmrCdtTrf>
				...
				<CdtTrfTxInf>
					<PmtId>
                        <!-- Uniquetransaction reference as generated by sending party. The same as MsgId in this message version -->
                    ...
                    <!--Instructed agent. DP who is receiving the payment and credited in PRISM. Participant in Field 56a of MT103. 
                    BICFI for SWIFT-registered BIC. ClrSysMmbId/MmbId for pseudo-BIC code (non-SWIFT registered)-->
					<InstdAgt>
						<FinInstnId>
							<BICFI>{data['Instructed_Agent']}</BICFI>
						</FinInstnId>
					...
					<!--Debtor agent account. Account in Fied 52a of MT103-->
					<DbtrAgtAcct>
						<Id>
							<Othr>
								<Id>{data['Debtor_Agent_Account']}</Id>
							</Othr>
						</Id>
					</DbtrAgtAcct>
...
<DataPDU xmlns="urn:cma:stp:xsd:stp.1.0">
	<Body>
		...
		<AppHdr xmlns="urn:iso:std:iso:20022:tech:xsd:head.001.001.02">
			...
			<!-- Message Reference -->
			<BizMsgIdr>ADPSPKR103004</BizMsgIdr>
			<!-- Message Type -->
			<MsgDefIdr>pacs.008.001.08</MsgDefIdr>
			<!-- Business Service -->
			<BizSvc>sbp.rtgs.01</BizSvc>
		...
		<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08">
			<FIToFICstmrCdtTrf>
				...
				<CdtTrfTxInf>
					<PmtId>
                        <!-- Uniquetransaction reference as generated by sending party. The same as MsgId in this message version -->
						<InstrId>ADPSPKR103004</InstrId>
						<!--End-to-End reference. Equivalent of field 70:/ROC/ in MT103 in this message version. NOTPROVIDED if there no such reference -->
						<EndToEndId>PREVPKK0103004</EndToEndId>
                        <!-- Unique transaction reference as generated by sending party. The same as MsgId in this message version-->
						<TxId>ADPSPKR103004</TxId>
						<!-- UETR-->
