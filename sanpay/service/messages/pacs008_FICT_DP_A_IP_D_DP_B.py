data = {
    ...
    'Creditor_Client': 'DIPNPKK0',
    'Creditor_Client_Account': '1356789024',
}
		...
		<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08">
			<FICdtTrf>
				...
				<CdtTrfTxInf>
                    ...
                    <!-- Creditor agent. Participant in Field 57a of MT202. BICFI for SWIFT-registered participants. 
                    ClrSysMmbId/MmbId for pseudo-BIC code (non-SWIFT registered) -->
					<CdtrAgt>
						<FinInstnId>
					...
					<Cdtr>
						<FinInstnId>
							<ClrSysMmbId>
								<MmbId>{data['Creditor_Client']}</MmbId>
							</ClrSysMmbId>
						</FinInstnId>
					</Cdtr>
					<!--Creditor account. -->
...
<DataPDU xmlns="urn:cma:stp:xsd:stp.1.0">
	<Body>
		...
		<AppHdr xmlns="urn:iso:std:iso:20022:tech:xsd:head.001.001.02">
			...
			<BizSvc>sbp.rtgs.01</BizSvc>
			<!-- Message Creation Date/Time-->
			<CreDt>2019-09-29T10:01:20+05:00</CreDt>
			<!--Payment priority -->
			<Prty>0020</Prty>
		</AppHdr>
		<!-- Document -->
...
<!-- Unique transaction reference as generated by sending party. The same as MsgId in this message version -->
					...
					<!-- Creditor agent. Participant in Field 57a of MT202. BICFI for SWIFT-registered participants. ClrSysMmbId/MmbId for pseudo-BIC code (non-SWIFT registered) -->
					<CdtrAgt>
						<FinInstnId>
							<BICFI>HSBCPKKX</BICFI>
						</FinInstnId>
