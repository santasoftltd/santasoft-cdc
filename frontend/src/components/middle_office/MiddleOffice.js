...
import './MiddleOffice.css'
import './SideBarMenu.css'
import { useState } from 'react'

const pages = [
  {
    'name': 'Middle Office Page One',
    'value': 'p1'
  },
  {
    'name': 'Middle Office Page Two',
    'value': 'p2'
  },
  {
    'name': 'Middle Office Page Three',
    'value': 'p3'
  },
  {
    'name': 'Middle Office Page Four',
    'value': 'p4'
  },
]

function MiddleOffice({user, module, normalize}) {
