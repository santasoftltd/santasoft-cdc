...
const pages = [
  {
    'name': 'General Ledger Page One',
    'value': 'p1'
  },
  {
    'name': 'General Ledger Page Two',
    'value': 'p2'
  },
  {
    'name': 'General Ledger Page Three',
    'value': 'p3'
  },
  {
    'name': 'General Ledger Page Four',
    'value': 'p4'
  },
]

function GeneralLedger({user, module, normalize}) {
