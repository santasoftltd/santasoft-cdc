...
function FMS_SecurityTransactions({ user, fromDate, toDate, addMessageHandler }) {
    ...
    return (
        <div className='table-container' style={{ gridColumnStart: '1', gridColumnEnd: '4', gridRowStart: '2', gridRowEnd: '4' }}>
            ...
            <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
                ...
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>FMS Security Transactions</p>
...
export default FMS_SecurityTransactions