...
function AuthorizedSecurityTransactionGride({ user, addMessageHandler }) {
    ...
    return (
      <div className='table-container' style={{gridColumnStart:'3', gridColumnEnd:'5'}}>
        ...
        <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
          <p style={{ display: 'inline', cursor: 'pointer' }}>Authorization</p>
...
export default AuthorizedSecurityTransactionGride