...
function UploadSecurityTransactions({ user, setSecurityTransactionUpload, addMessageHandler }) {
    ...
    return (
        <div className='black-background'>
            <div className='float-component1'>
                ...
                <div>
                    <PopUpWindowHeader title={'Upload Security Transactions'} onNewEntryClicked={null} />
                </div>

                <div className="upload-security-transaction">
                    <div className="upload-security-transaction-home">

                        <div className="upload-security-transaction-sub-home">
                            <div className='table-container'>
                                {/* Table Title */}
                                <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
                                    <p style={{ display: 'inline', cursor: 'pointer' }}>Transactions</p>
                            ...
                            <button className='cancel-button' onClick={() => setSecurityTransactionUpload(false)}>Cancel</button>
                        </div>
...
export default UploadSecurityTransactions