...
function AuthorizedCashTransactionGride({ user, onTableSelect, addMessageHandler }) {
    ...
    return (
      <div className='table-container' style={{gridColumnStart:'3', gridColumnEnd:'5'}}>
        {/* Table Title */}
        <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
          <p style={{ display: 'inline', cursor:'pointer', margin:'0px 0px 0px 10px' }}>Authorization</p>
...
export default AuthorizedCashTransactionGride