...
function CashTransactionForm({ user, addMessageHandler }) {
    ...
    return (
      <div className='table-container' style={{gridColumnStart:'4', gridColumnEnd:'5', gridRowStart:'2', gridRowEnd:'4'}}>

        {/* Table Title */}
        <div className='table-container-name' style={{ paddingBottom: '4px' }}>
          <p style={{ display: 'inline', cursor:'pointer', margin:'0px 0px 0px 10px' }}>Form</p>
