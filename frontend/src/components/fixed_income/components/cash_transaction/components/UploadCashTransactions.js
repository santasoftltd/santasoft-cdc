...
function UploadCashTransactions({ user, setCashTransactionUpload, addMessageHandler }) {
  ...
  return (
      <div className='black-background'>
          <div className='float-component1'>
              ...
              <div>
                <PopUpWindowHeader title={'Upload Cash Transactions'} onNewEntryClicked={null} />
              </div>
              ...
              <div className="upload-security-transaction">
                  <div className="upload-security-transaction-home">
                      ...
                      <div className="upload-security-transaction-sub-home">
                          ...
                          <button className='cancel-button' onClick={() => setCashTransactionUpload(false)}>Cancel</button>
                      </div>
...
export default UploadCashTransactions