...
function UpcomingCouponMaturities({user, onTableSelect, addMessageHandler}) {
    ...
    return (
        <div className='table-container'>
            ...
            <div className='table-container-name' style={{ border: 'none', paddingBottom:'4px' }}>
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>Upcoming maturities: </p>
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => onTableSelect('principle')}>Principle</p>
                <p style={{ display: 'inline', borderBottom: '2px solid #1c4966', cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => onTableSelect('coupon')}>Coupon</p>
            </div>
...
export default UpcomingCouponMaturities