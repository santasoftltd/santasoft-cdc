...
function SecuritiesForm({ user, securityType, userInput, setUserInput, addMessageHandler }) {
    ...
    return (
        <div className='table-container'>
            ...
            <div className='table-container-name' style={{ paddingBottom: '4px' }}>
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>Security</p>
            </div>
