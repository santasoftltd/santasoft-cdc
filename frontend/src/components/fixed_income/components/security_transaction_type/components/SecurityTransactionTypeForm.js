...
function SecurityTransactionTypeForm({ user, refresh, date, userInput, setUserInput, data, setData, addMessageHandler }) {
...
export default SecurityTransactionTypeForm