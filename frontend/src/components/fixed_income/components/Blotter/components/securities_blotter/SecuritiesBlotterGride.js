...
function SecuritiesBlotterGride({ user, fromDate, toDate, type, setType, addMessageHandler }) {
    ...
    return (
        <div className='table-container' style={{ gridColumnStart: '1', gridColumnEnd: '4', gridRowStart: '2', gridRowEnd: '4' }}>
            ...
            <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>Blotter: </p>
                <p style={{ display: 'inline', borderBottom: getTypeBorder('all'), cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => setType('all')}>All</p>
                <p style={{ display: 'inline', borderBottom: getTypeBorder('sale'), cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => setType('sale')}>Sale</p>
                <p style={{ display: 'inline', borderBottom: getTypeBorder('purchase'), cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => setType('purchase')}>Purchase</p>
...
export default SecuritiesBlotterGride