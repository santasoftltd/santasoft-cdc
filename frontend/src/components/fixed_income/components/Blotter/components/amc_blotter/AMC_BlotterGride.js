...
function AMC_BlotterGride({ user, date, account, setAccount, status, setStatus, accountList, statusList, addMessageHandler }) {
    ...
    return (
        <div className='table-container' style={{ gridColumnStart: '1', gridColumnEnd: '4', gridRowStart: '2', gridRowEnd: '4' }}>
            ...
            <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
                ...
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>AMC: </p>
                <select style={{ marginLeft: '0px' }} onChange={e => setAccount(e.target.value)}>
                ...
                <p style={{ display: 'inline', cursor: 'pointer', margin: '0px 0px 0px 10px' }}>Status: </p>
                <select style={{ marginLeft: '0px' }} onChange={e => setStatus(e.target.value)}>
                    <option value='All'>All</option>
...
export default AMC_BlotterGride