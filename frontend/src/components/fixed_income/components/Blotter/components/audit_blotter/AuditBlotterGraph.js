...
function AuditBlotterGraph({ user, fromDate, toDate, account, setAccount, accountList, addMessageHandler }) {
    ...
    return (
      <div className='table-container' style={{gridColumnStart:'1', gridColumnEnd:'4', gridRowStart:'2', gridRowEnd:'4'}}>
        ...
        <div className='table-container-name' style={{ paddingBottom: '4px' }}>
          <p style={{ display: 'inline', cursor:'pointer', margin:'0px 0px 0px 10px' }}>Visualize</p>
...
export default AuditBlotterGraph