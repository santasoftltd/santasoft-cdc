...
function CashBlotterGride({ user, fromDate, toDate, type, setType, addMessageHandler }) {
    ...
    return (
        <div className='table-container' style={{ gridColumnStart: '1', gridColumnEnd: '4', gridRowStart: '2', gridRowEnd: '4' }}>
            ...
            <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
                ...
                <p style={{ display: 'inline', borderBottom: getTypeBorder('inflow'), cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => setType('inflow')}>Inflow</p>
                <p style={{ display: 'inline', borderBottom: getTypeBorder('outflow'), cursor: 'pointer', margin: '0px 8px 0px 10px' }} onClick={() => setType('outflow')}>Outflow</p>
...
export default CashBlotterGride