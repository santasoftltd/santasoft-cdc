...
function RealTimeCompaniesAccountsList({ user, addMessageHandler }) {
  ...
  return (
    <div className='table-container' style={{ gridRowStart: '3', gridColumnStart: '1', gridColumnEnd: '3' }}>
      ...
      <div className='table-container-name' style={{ border: 'none', paddingBottom: '4px' }}>
        <p style={{ display: 'inline', cursor: 'pointer' }}>Accounts</p>
...
export default RealTimeCompaniesAccountsList