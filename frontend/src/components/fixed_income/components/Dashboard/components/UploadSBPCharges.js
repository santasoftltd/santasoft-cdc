...
function UploadSBPCharges({ user, setSBPChargesUpload, addMessageHandler }) {
    ...
    return (
        <div className='black-background'>
            <div className='float-component1'>
                ...
                <div>
                  <PopUpWindowHeader title={'Upload SBP Charges'} onNewEntryClicked={null} />
                </div>
  
                <div className="upload-sbp-charges">
                    <div className="upload-sbp-charges-home">
  
                        <div className="upload-sbp-charges-sub-home">
                            ...
                            <button className='cancel-button' onClick={() => setSBPChargesUpload(false)}>Cancel</button>
                        </div>
...
export default UploadSBPCharges