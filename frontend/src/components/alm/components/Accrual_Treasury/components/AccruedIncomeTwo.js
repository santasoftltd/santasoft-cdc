...
function AccruedIncomeTwo({ user, refresh, fromDate, toDate, addMessageHandler }) {
    ...
    return (
        <div className='table-container'>
            ...
            <div className='table-container-name'>
                <p style={{ display: 'inline' }}>Accrued Income - Bai, Call</p>
...
export default AccruedIncomeTwo