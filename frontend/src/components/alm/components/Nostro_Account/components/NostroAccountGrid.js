...
function NostroAccountGrid({ user, refresh, date, data, setData, setUserInput, addMessageHandler }) {
          ...
          <tbody>
            {
              data.map((object, index) => (
                <tr key={index} onDoubleClick={() => setUserInput(object)}>
                  ...
                  {columns[0].display && <td>{object["currency"]}</td>}
...
export default NostroAccountGrid