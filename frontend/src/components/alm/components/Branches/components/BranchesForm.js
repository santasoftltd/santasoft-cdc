...
function BranchesForm({ user, refresh, date, userInput, setUserInput, data, setData, addMessageHandler }) {
        ...
        <div className='table-container'>
            ...
            <div className='deal-form'>
                ...
                <div className='deal-form-container'>
                    ...
                    <div>
                        <label>Code:</label>
                        <input type="text" onChange={e => setUserInput({ ...userInput, 'code': e.target.value })} value={userInput.code} />
                    </div>

                    <div>
                        <label>Name:</label>
                        <input type="text" style={{ width: '300%' }} onChange={e => setUserInput({ ...userInput, 'name': e.target.value })} value={userInput.name} />
                    </div>
