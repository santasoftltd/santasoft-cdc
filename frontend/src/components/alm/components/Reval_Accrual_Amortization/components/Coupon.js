...
function Coupon({ user, refresh, date, addMessageHandler }) {
              ...
              <tbody>
                {
                  data.map((object) => (
                    <tr key={object["id"]}>
                      ...
                      {columns[0].display && <td>{formatter(object["dtm"])}</td>}
                      {columns[1].display && <td>{dateFormatter(object["lcd"])}</td>}
                      {columns[2].display && <td>{dateFormatter(object["ncd"])}</td>}
                    </tr>
                  ))
                }
              </tbody>
