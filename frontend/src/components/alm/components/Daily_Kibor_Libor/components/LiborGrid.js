...
function LiborGrid({ user, refresh, date, addMessageHandler }) {
  ...
  return (
    <div className='table-container'>
      ...
      <div className='table-container-name' style={{borderBottom: 'none'}}>
        <p style={{ display: 'inline' }}>Daily LIBOR</p>
          ...
          <tbody>
            {data.map((object) => (
              <tr key={object["id"]}>
                ...
                {columns[2].display && <td>{formatter(object["month_1"])}</td>}
                {columns[3].display && <td>{formatter(object["month_2"])}</td>}
                {columns[4].display && <td>{formatter(object["month_3"])}</td>}
                {columns[5].display && <td>{formatter(object["month_6"])}</td>}
                {columns[6].display && <td>{formatter(object["month_9"])}</td>}
                {columns[7].display && <td>{formatter(object["month_12"])}</td>}
                {columns[8].display && <td>{formatter(object["year_2"])}</td>}
                {columns[9].display && <td>{formatter(object["year_3"])}</td>}
              </tr>
            ))
            }
          </tbody>
