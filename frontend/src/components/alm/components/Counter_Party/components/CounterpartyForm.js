...
function CounterpartyForm({ user, refresh, date, userInput, setUserInput, data, setData, addMessageHandler }) {
    ...
    <div className='table-container'>
      ...
      <div className='deal-form'>
        ...
        <div className='deal-form-container'>
          ...
          <div>
            <label>Code:</label>
            <input type="text" style={{ width: '80px' }} onChange={e => setUserInput({ ...userInput, 'code': e.target.value })} value={userInput.code} />
          </div>
          ...
          <div>
            <label>Spot Limit:</label>
            <input type="text" style={{ width: '150px' }} onChange={e => setUserInput({ ...userInput, 'spot_limit': e.target.value })} value={numberWithCommas(userInput.spot_limit)} />
          </div>

          <div>
            <label>Forward Limit:</label>
            <input type="text" style={{ width: '150px' }} onChange={e => setUserInput({ ...userInput, 'forward_limit': e.target.value })} value={numberWithCommas(userInput.forward_limit)} />
          </div>
