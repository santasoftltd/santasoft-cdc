  ...
  return (
    <div className='table-container-actions'>
        ...
        <div className='actions-container'>
            ...
            {actions.modifiable && 
              actions.eraseHandler !== null && <div><img onClick={() => actions.eraseHandler()} className='action-pics' src={clearImgae} title="Clear" alt="Clear"/></div>
            }
            {actions.modifiable && 
              actions.submitHandler !== null && <div><img onClick={() => actions.submitHandler()} className='action-pics' src={saveImgae} title="Save" alt="Save"/></div>
            }
            <div><img onClick={() => actions.onDownloadButtonClicked()} className='action-pics' src={downloadImgae} title="Download" alt="Download"/></div>
            ...
            {actions.columnExpand && <TableColumnDisplay columns={actions.columns} allColumns={actions.allColumns} onExpandSelectClicked={actions.onExpandSelectClicked} actions={actions}/>}
            {actions.page !== null &&
              <>
                <div>
                  ...
                  <img className='paging-pic' src={rightImgae} title="right" alt="right" onClick={() => actions.onNextPage()}/>
                  {
                    actions.count === 0 
                    ?
                      <p className='paging-p' >0-0 of 0</p>
                    :
                ...
                {actions.showPage && <Paging page={actions.page} onPageSelect={actions.pageSizeSelect} actions={actions}/>}
              </>
            }
        </div>
    </div>
