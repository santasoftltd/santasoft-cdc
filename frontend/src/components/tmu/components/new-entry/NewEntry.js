...
function NewEntry({user, dealer, updateObject, setUpdateObject, onNewEntryClicked, date, dropdownLists, rates, transaction, addMessageHandler}) {
  return (
