...
function SalamInformation({rootDealTitles, rootDeal}) {
    ...
    <div className='table-container'>
      ...
      <div className='table-container-summary' style={{display:'grid', gridTemplateColumns:'1fr 1fr 1fr 1fr 1fr'}}>
        ...
        <div>
          ...
          <p className='table-container-summary-item2'>{dateFormatter(rootDeal[rootDealTitles[11].accessor])}</p>
        </div>

        <div>
          <p className='table-container-summary-item1'>{rootDealTitles[12].name}</p>
          <p className='table-container-summary-item2'>{formatter(rootDeal[rootDealTitles[12].accessor])}</p>
        </div>
        ...
        <div>
          ...
          <p className='table-container-summary-item2'>{formatter(rootDeal[rootDealTitles[9].accessor])}</p>
        </div>
...
export default SalamInformation