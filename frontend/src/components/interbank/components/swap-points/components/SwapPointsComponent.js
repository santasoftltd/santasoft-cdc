...
function SwapPointsComponent({ user, refresh, date, addMessageHandler }) {
    ...
    return (
        <div className='table-container'>
            ...
            <div className='table-container-name' style={{ border: 'none' }}>
                ...
                <div className='transaction-grid-button' onClick={() => swapPointsHandler()} >Run swap process</div>
            </div>
                    ...
                    <tbody>
                        {
                            data.map((object, index) => (
                                <tr key={index}>
                                    ...
                                    {columns[4].display && <td>{object["swap_points"]}</td>}
                                </tr>
                            ))
                        }
                    </tbody>
...
export default SwapPointsComponent