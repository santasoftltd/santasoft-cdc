import SbpRatesForm from './SbpRatesForm'
...
function SbpRates({ user, refresh, date, setDate, addMessageHandler }) {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        addMessageHandler({
          ...
          content: 'SBP reval grid failed to load due to unauthorized request.',
          type: 4
        })
      }
  ...
  return (
    <div className='home'>
      ...
      {isNewEntry && <FloatForm newItem={true} buttonTitle={'Upload'} title={'SBP Reval Rates'} onNewEntryClicked={onNewEntryClicked} submitHandler={uploadHandler} floatFormBody={<SbpRatesForm setUserInput={setUserInput} />} height={'fit-content'} />}
      ...
      <div className='salam-sheet-sub-home'>
        ...
        <div className='table-container'>
          ...
          <div className='table-container-name' style={{ border: 'none' }}>
            ...
            <div className='transaction-grid-button' onClick={() => onNewEntryClicked()}>Upload</div>
          </div>
