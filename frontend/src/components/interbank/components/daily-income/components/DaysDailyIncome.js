...
function DaysDailyIncome({ user, refresh, year, monthNumber, month, addMessageHandler }) {
    ...
    return (
        <div className='table-container'>
            ...
            <div className='table-container-name' style={{ border: 'none' }}>
                <p style={{ display: 'inline' }}>Daily cash flow - {month} {year}</p>
...
export default DaysDailyIncome