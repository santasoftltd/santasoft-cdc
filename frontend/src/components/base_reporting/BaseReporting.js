...
import './BaseReporting.css'
import './SideBarMenu.css'
import { useState } from 'react'

const pages = [
  {
    'name': 'Base Reporting Page One',
    'value': 'p1'
  },
  {
    'name': 'Base Reporting Page Two',
    'value': 'p2'
  },
  {
    'name': 'Base Reporting Page Three',
    'value': 'p3'
  },
  {
    'name': 'Base Reporting Page Four',
    'value': 'p4'
  },
]

function BaseReporting({user, module, normalize}) {
